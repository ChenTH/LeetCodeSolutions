...
public class ReorderList {
    ...
    public static void main(String[] args) {
        ...
        com.cth.backup.LinkList.medium.ListNode node1 = new ListNode(1);
        com.cth.backup.LinkList.medium.ListNode node2 = new ListNode(2);
        com.cth.backup.LinkList.medium.ListNode node3 = new ListNode(3);
